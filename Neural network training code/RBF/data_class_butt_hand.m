...
data_paper=[2*ones(length(data_paper(1:768,:)),1),data_paper(1:768,:)];
data_rubber=[2*ones(length(data_rubber(1:791,:)),1),data_rubber(1:791,:)];
data_iron=[2*ones(length(data_iron(1:772,:)),1),data_iron(1:772,:)];
...
feature_test = zeros(testnum,23);
feature_train = zeros(trainnum,23);
