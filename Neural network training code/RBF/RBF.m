...
% 
% save(['F:\外力碰撞代码\在线实验数据与程序\RBF\统计图滤波组\',f_str1],'net');
% save(['F:\外力碰撞代码\在线实验数据与程序\RBF\统计图滤波组\',f_str2],'train_ps');
% save(['F:\外力碰撞代码\在线实验数据与程序\RBF\统计图滤波组\',f_str3],'output_ps');
% save(['F:\外力碰撞代码\在线实验数据与程序\RBF\统计图滤波组\',f_str4],'accuracy','-ascii', '-append');
